...
field = 'E'  # Set this to 'E' if you want to display E field instead of B field
...
model_out2vtp = XMLPolyDataReader(registrationName='model_out (2).vtp', FileName=['/Users/johantrippitelli/Desktop/model_out (2).vtp'])
...
model_out2vtpDisplay.ScaleTransferFunction.Points = [-61.650726318359375, 0.0, 0.5, 0.0, 61.65370559692383, 1.0, 0.5, 0.0]

# init the 'PiecewiseFunction' selected for 'OpacityTransferFunction'
model_out2vtpDisplay.OpacityTransferFunction.Points = [-61.650726318359375, 0.0, 0.5, 0.0, 61.65370559692383, 1.0, 0.5, 0.0]
...
# init the 'PiecewiseFunction' selected for 'ScaleTransferFunction'
calculator1Display.ScaleTransferFunction.Points = [-61.650726318359375, 0.0, 0.5, 0.0, 61.65370559692383, 1.0, 0.5, 0.0]

# init the 'PiecewiseFunction' selected for 'OpacityTransferFunction'
calculator1Display.OpacityTransferFunction.Points = [-61.650726318359375, 0.0, 0.5, 0.0, 61.65370559692383, 1.0, 0.5, 0.0]
...
# init the 'PiecewiseFunction' selected for 'ScaleTransferFunction'
glyph1Display.ScaleTransferFunction.Points = [-61.650726318359375, 0.0, 0.5, 0.0, 56.56791305541992, 1.0, 0.5, 0.0]

# init the 'PiecewiseFunction' selected for 'OpacityTransferFunction'
glyph1Display.OpacityTransferFunction.Points = [-61.650726318359375, 0.0, 0.5, 0.0, 56.56791305541992, 1.0, 0.5, 0.0]
...
bfieldVectorsLUT.RGBPoints = [0.0005679527295045824, 0.231373, 0.298039, 0.752941, 35.535166598578776, 0.865003, 0.865003, 0.865003, 71.06976524442805, 0.705882, 0.0156863, 0.14902]
...
bfieldVectorsPWF.Points = [0.0005679527295045824, 0.0, 0.5, 0.0, 71.06976524442805, 1.0, 0.5, 0.0]
...
massdensityMagnitudeLUT.RGBPoints = [19600.0, 0.231373, 0.298039, 0.752941, 27680.0, 0.865003, 0.865003, 0.865003, 35760.0, 0.705882, 0.0156863, 0.14902]
...
renderView1.CameraPosition = [-0.023961155911634377, -0.0006015590877343993, -0.18766203396447664]
renderView1.CameraFocalPoint = [0.0, 0.0, 0.037450000643730164]
renderView1.CameraViewUp = [-0.8208929610135638, -0.564122637477454, 0.08888417431615632]
