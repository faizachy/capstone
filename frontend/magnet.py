...
# so magnet_script_temp will be written and run each time we do the field extraction, though magnet_script.vbs is what needs to be modified to make actual changes to the magnet script
